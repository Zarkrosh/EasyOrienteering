...
INSERT INTO CARRERAS(ID, SECRET, NOMBRE, TIPO, MODALIDAD, ORGANIZADOR_ID, LATITUD, LONGITUD, PRIVADA) VALUES (1, 'not-a-real-secret', 'Prueba de carrera', 'EVENTO', 'LINEA', 1, 42.5221944, -4.7366028, FALSE);
INSERT INTO CARRERAS(ID, SECRET, NOMBRE, TIPO, MODALIDAD, ORGANIZADOR_ID, LATITUD, LONGITUD, PRIVADA) VALUES (2, 'not-a-real-secret', 'Otra carrera', 'EVENTO', 'SCORE', 3, NULL, NULL, FALSE);
