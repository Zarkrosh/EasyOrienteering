...
INSERT INTO CARRERAS(ID, SECRET, NOMBRE, TIPO, MODALIDAD, ORGANIZADOR_ID, LATITUD, LONGITUD, PRIVADA, NOTAS) VALUES (1, 'not-a-real-secret', 'Prueba de carrera', 'EVENTO', 'TRAZADO', 1, 42.5221944, -4.7366028, FALSE, 'La salida de la carrera estará en el centro del parque en una mesa.\nPara cualquier duda contactar con usuario@dominio.com.');
