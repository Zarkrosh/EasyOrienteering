...
CREATE TABLE IF NOT EXISTS CONTROLES_RECORRIDO (
	...
	ORDEN SMALLINT,
	CONTROL_ID INTEGER REFERENCES CONTROLES(ID) ON DELETE CASCADE,
...
/**** DATOS DE PRUEBA ****/
ALTER SEQUENCE carreras_id_seq restart with 3;
...
INSERT INTO CONTROLES_RECORRIDO(RECORRIDO_ID, ORDEN, CONTROL_ID) VALUES (1, 0, 1); -- S1
INSERT INTO CONTROLES_RECORRIDO(RECORRIDO_ID, ORDEN, CONTROL_ID) VALUES (1, 1, 2); -- 31
INSERT INTO CONTROLES_RECORRIDO(RECORRIDO_ID, ORDEN, CONTROL_ID) VALUES (1, 2, 4); -- 33
INSERT INTO CONTROLES_RECORRIDO(RECORRIDO_ID, ORDEN, CONTROL_ID) VALUES (1, 3, 5); -- M1
/* Trazado Open naranja */
INSERT INTO CONTROLES_RECORRIDO(RECORRIDO_ID, ORDEN, CONTROL_ID) VALUES (2, 0, 1); -- S1
INSERT INTO CONTROLES_RECORRIDO(RECORRIDO_ID, ORDEN, CONTROL_ID) VALUES (2, 1, 3); -- 32
INSERT INTO CONTROLES_RECORRIDO(RECORRIDO_ID, ORDEN, CONTROL_ID) VALUES (2, 2, 2); -- 31
INSERT INTO CONTROLES_RECORRIDO(RECORRIDO_ID, ORDEN, CONTROL_ID) VALUES (2, 3, 4); -- 33
INSERT INTO CONTROLES_RECORRIDO(RECORRIDO_ID, ORDEN, CONTROL_ID) VALUES (2, 4, 5); -- M1
/* Trazado Open rojo (vacío) */
/* Trazado carrera 2 (SCORE) */
INSERT INTO CONTROLES_RECORRIDO(RECORRIDO_ID, ORDEN, CONTROL_ID) VALUES (4, 0, 6); -- S1
INSERT INTO CONTROLES_RECORRIDO(RECORRIDO_ID, ORDEN, CONTROL_ID) VALUES (4, 1, 14); -- M1


/* Pepito: Open amarillo acabado */
...
/* Pepito: Open naranja sin acabar */
...
/* Juanito: carrera score acabada con algunos controles */
