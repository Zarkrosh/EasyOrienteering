...
INSERT INTO CARRERAS(ID, SECRET, NOMBRE, TIPO, MODALIDAD, ORGANIZADOR_ID, PRIVADA) VALUES (1, 'not-a-real-secret', 'Prueba de carrera', 'EVENTO', 'LINEA', 1, FALSE);
...
INSERT INTO RECORRIDOS(NOMBRE, CARRERA_ID, MAPA) VALUES ('OPEN NARANJA', 1, PG_READ_BINARY_FILE('/tmp/img_sample_map.jpg'));
INSERT INTO RECORRIDOS(NOMBRE, CARRERA_ID, MAPA) VALUES ('OPEN ROJO', 1, PG_READ_BINARY_FILE('/tmp/img_sample_map.jpg'));
