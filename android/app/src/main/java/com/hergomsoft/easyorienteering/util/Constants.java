...
public class Constants {
    ...
    public static final String REGEX_SCAN_TRIANGULO = "^S\\d+" + SEPARADOR_QR_REGEX + "\\d+" + SEPARADOR_QR_REGEX + "\\d+" + SEPARADOR_QR_REGEX + "[0-9a-zA-Z]+$"; // CODIGO IDCARRERA IDRECORRIDO SECRETO
    public static final String REGEX_SCAN_CONTROL = "^\\d+" + SEPARADOR_QR_REGEX + "[0-9a-zA-Z]+$";
    public static final String REGEX_SCAN_META = "^M\\d+" + SEPARADOR_QR_REGEX + "[0-9a-zA-Z]+$";
}
